...
public class MoveCamera : MonoBehaviour
{
    ...
    private void MoveCP()
    {
        ...
        if (Mathf.Abs(translation_hand.x) > 0.001f || Mathf.Abs(translation_hand.y) > 0.001f)
        {
            ...
            */
            ...
            Debug.Log("X movement: " + translation_hand.x.ToString("F4"));
        }
        else
        {
