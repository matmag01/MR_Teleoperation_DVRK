...
public class temp : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bounds = quad.GetComponent<Renderer>().bounds;
        bottomLeft = bounds.center
        ...
        tipOnQuadPlanePSM1 = bottomLeft + quad.transform.right * (bounds.size.x * uvPSM1.x) + quad.transform.up * (bounds.size.y * (1 - uvPSM1.y));
        worldPosPSM1 = tipOnQuadPlanePSM1 + quad.transform.forward * zPSM1;

        tipOnQuadPlanePSM2 = bottomLeft + quad.transform.right * (bounds.size.x * uvPSM2.x) + quad.transform.up * (bounds.size.y * (1 - uvPSM2.y));
        worldPosPSM2 = tipOnQuadPlanePSM2 + quad.transform.forward * zPSM2;
        ...
        tipOnQuadPlaneEndPSM1 = bottomLeft + quad.transform.right * (bounds.size.x * uvEndPSM1.x) + quad.transform.up * (bounds.size.y * (1 - uvEndPSM1.y));
        tipOnQuadPlaneEndPSM2 = bottomLeft + quad.transform.right * (bounds.size.x * uvEndPSM2.x) + quad.transform.up * (bounds.size.y * (1 - uvEndPSM2.y));

        worldPosEndPSM1 = tipOnQuadPlaneEndPSM1 + quad.transform.forward * zEnd;
        worldPosEndPSM2 = tipOnQuadPlaneEndPSM2 + quad.transform.forward * zEnd;
        /*
