...
class StereoConcatenator:
    ...
    def callback(self, left_msg, right_msg):
        ...
        try: 
            ...
            # Pubblica immagini singole con solo quadrato mobile
